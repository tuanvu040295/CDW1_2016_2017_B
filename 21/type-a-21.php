...
<html>
    ...
    <head>
        ...
        $less = new lessc;
        $less->compileFile('less/type-a-21.less', 'css/type-a-21.css');
        ?>
        <link href="css/type-a-21.css" rel="stylesheet" type="text/css" />
        ...
        <div class="type-a-21">
            <div id="user1" class="container">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="moduletable " id="mod204" data-id="204">
                            <div class="bghelper">

                                <h4 class="moduletitle ">VM - Search in Shop</h4>
                                <div class="modulecontent">
                                    <!--BEGIN Search Box -->
                                    <form action="/kallyas_joomla/shop/category-layout/search" method="get">
