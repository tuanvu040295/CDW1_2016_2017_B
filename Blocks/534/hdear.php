<head>
    ...
    $less = new lessc;
    $less->compileFile('less/hdear.less', 'css/hdear.css');
    ?>

    <link href="css/hdear.css" rel="stylesheet" type="text/css"/>
        ...
        <div id="header" class="group header_with_search margin-bottom">
                    ...
                    <nav class="navbar navbar-inverse">
                        ...
                        <div class="collapse navbar-collapse js-navbar-collapse" id="myNavbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Login/Register <span class="caret"></span></a>
                                    <ul class="dropdown-menu register">
                                        <form>
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Username"> </div>
                                            <div class="form-group">
                ...
                <div id="headersearchform-container" class="group">
                    <form role="search" method="get" id="headersearchform" action="#">
                        <div class="group formborder">
                            ...
                            <div class="autocomplete-suggestions" style="position: absolute; display: none; width: 766px; max-height: 300px; z-index: 9999;"></div>
                        </div>
            ...
            <div class="header-below">
                <div class="slider fixed-image inner group">
                    <div class="fixed-image-wrapper" style="max-width: 1920px;"> <img src="images/fixed-image.jpg" alt="Sistina Header"> </div>
                </div>
                <!-- SLOGAN -->
                <div class="slogan">
                    <h2 class="nopadding">
                        <img src="images/cart1.png" class="yit-image">I'm Sistina theme. <strong>Nice to meet you.</strong></h2> </div>
            </div>
        </div>
    </div>
</body>
