                                ...
                                <ul>
                                    <li class="with-icon">
                                        <div class="input-prepend"> <span class="add-on"><i class="icon-contact-name"></i></span>
                                            <input type="text" name="yit_contact[name]" class="with-icon" value="" placeholder="Name"> </div>
                                    </li>
                                    <li class="with-icon">
                                        <div class="input-prepend"> <span class="add-on"><i class="icon-contact-email"></i></span>
                                            <input type="text" name="yit_contact[ ]" class="with-icon" value="" placeholder="Email"> </div>
                                    </li>
                                    <li class=" with-icon">
                                        <div class="input-prepend"> <span class="add-on"><i class="icon-contact-phone"></i></span>
                                            <input type="text" name="yit_contact[phone]" class="with-icon" value="" placeholder="Phone"> </div>
                                    </li>
                                    <li class=" with-icon">
                    ...
                    <div class="tab-pane" id="reviews-tab" >
                        <div id="reviews" >
                            ...
                            <div >
                                <div id="review_form">
                                    <div id="respond" >
                                        <h3 id="reply-title" >Be the first to review “Belt” <small><a rel="nofollow" href="/sistina/all-products/belt/#respond" style="display:none;">Cancel reply</a></small></h3>
                                        <form action="#" method="post" >
                                            <p ><span >Your address will not be published.</span> Required fields are marked <span >*</span> </p>
                                            <p >
                                                <label for="rating">Your Rating</label>
                                                <select name="" aria-required="true" required="" style="display: none;">
                                            ...
                                            <p >
                                                ...
                                                <input name="" type="" value="" size="30" aria-required="true" required=""> </p>
                                            <p >
                                                <input name="submit" type="submit" id="submit" class="submit" value="Submit">
                                                <input type="hidden" name="" value="139" >
                                                <input type="hidden" name="" value="0"> </p>
                                            <p class=" -q" style="clear: both; display: none;">
                                                <label>Current ye@r <span >*</span> </label>
                                                <input type="hidden" name="antspm-a" class=" -a" value="2016">
                                                <input type="text" name="antspm-q" class=" -q" value="4.2" autocomplete="off"> </p>
                                            <p class=" -e" style="display: none;">
                                                <label>Leave this field empty</label>
                                                <input type="text" name="antspm-e -url-website" class=" -e" value="" autocomplete="off"> </p>
                                            <input type="hidden" name="antspm-d" class=" -d" value="2016"> </form>
                                    </div>
                                </div>
                            </div>
