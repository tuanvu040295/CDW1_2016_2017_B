<?php
$root_url = 'http://localhost:82/type_a_3/';
...
if (!empty($id)) {
    $url =  'http://localhost:82/type_a_3/type_a_3.php';

    $url_less = 'http://localhost:82/type_a_3/less/styles.less';
    $url_bootsrap = 'http://localhost:82/type_a_3/css/bootstrap.min.css';
    $url_awesome =  'http://localhost:82/type_a_3/css/font-awesome.min.css';
