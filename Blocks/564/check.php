<?php
$root_url = 'http://localhost/type_a_2';
...
if (!empty($id)) {
    $url =  'http://localhost/type_a_2/type_a_2.php';

    $url_less = 'http://localhost/type_a_2/less/styles.less';
    $url_bootsrap = 'http://localhost/type_a_2/css/bootstrap.min.css';
    $url_awesome =  'http://localhost/type_a_2/css/font-awesome.min.css';
