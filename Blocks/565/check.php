<?php
$root_url = 'http://localhost/type_a_2_chitiet1/';
...
if (!empty($id)) {
    $url =  'http://localhost/type_a_2_chitiet1/type_a_2_chitiet1.php';

    $url_less = 'http://localhost/type_a_2_chitiet1/less/styles.less';
    $url_bootsrap = 'http://localhost/type_a_2_chitiet1/css/bootstrap.min.css';
    $url_awesome =  'http://localhost/type_a_2_chitiet1/css/font-awesome.min.css';
